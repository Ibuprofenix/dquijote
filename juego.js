document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- LIMPIEZA QUIRÚRGICA ---
    // Eliminamos: if(window.GestionDatos) window.GestionDatos.enviarGesta(...)
    // No enviamos nada aquí. Dejamos que la Interfaz gestione los botones.

    if (window.Interfaz) {
        // Esta función ahora se encarga de mostrar los puntos 
        // y configurar los botones de "SIGUIENTE" o "REGISTRAR"
        Interfaz.mostrarPantallaFinal(victoria, resultados);
    }
}
    };
