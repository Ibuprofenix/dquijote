const AudioEngine = {
    ...
    reproducir(nombre) {
        ...
        switch (nombre) {
			// ... dentro del switch(nombre) ...

case 'aturdido':
    // Sonido de "pajariitos" o mareo (3 pitidos rápidos ascendentes)
    for (let i = 0; i < 3; i++) {
        this.tocarNota(600 + (i * 200), t + (i * 0.1), 0.1);
    }
    break;

case 'choque_suelo':
    // Impacto sordo y grave (cuando la roca toca el suelo)
    osc.type = 'triangle';
    osc.frequency.setValueAtTime(100, t);
    osc.frequency.linearRampToValueAtTime(10, t + 0.2);
